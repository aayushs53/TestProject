...
public class TestBase {
	...
	public TestBase(){
		try {
			...
			FileInputStream ip = new FileInputStream("C:\\Users\\aayush\\eclipse-workspace\\FreeCRMTest\\src\\main\\java\\com\\fedex\\qa\\config\\config.properties");
